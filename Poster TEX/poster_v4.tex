...
\begin{itemize}
    \item[\ding{228}]  \textbf{SDC} is the traditional approach to protect data against re-identification
        \begin{itemize}
            ...
            e.g. Local suppression, %(delete high-risk records)
...
\includegraphics[width=1\linewidth]{Poster TEX/figures/Mosaic_orig.png}

\includegraphics[width=1\linewidth]{Poster TEX/figures/Mosaic_synt}
